...
class Executer(object):
    ...
    def ConvertToPyDev(self):
        ...
        for template, filename, title in all:
            ...
            path_html_rst = os.path.join(r'W:\pydev\plugins\com.python.pydev.docs\merged_homepage', title_to_filename[title] + '.rst')
            if os.path.exists(path_html_rst):
                os.remove(path_html_rst)
            
            path_html_rst = os.path.join(r'W:\pydev\plugins\com.python.pydev.docs\merged_homepage', title_to_filename[title] + '.contents.rst')
            if os.path.exists(path_html_rst):
                os.remove(path_html_rst)
                
            path_html = os.path.join(r'W:\pydev\plugins\com.python.pydev.docs\merged_homepage', filename + '.contents.html')
